	...
	public class Converter
	{
		...
		private void ExportMarkdown (ParsedFileInfo info, ConverterOptions options, MainMenu menu)
		{
			if (info.ShouldBeGenerated) {
				...
				var templateData = new { content = info.ParsedContent, menu = menu, title = info.Title, description = info.Description, author = info.Author, sidebarheader = info.Sidebar, sidebaritems = sidebarItems };
